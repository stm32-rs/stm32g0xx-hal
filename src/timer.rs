...
impl CountDown for Timer<SYST> {
    ...
    where
        T: Into<Hertz>,
    {
        let rvr = self.clocks.core_clk.0 / timeout.into().0 - 1;
        assert!(rvr < (1 << 24));
...
timers! {
    TIM1: (tim1, tim1en, tim1rst, apbenr2, apbrstr2, apb_tim_clk),
    TIM2: (tim2, tim2en, tim2rst, apbenr1, apbrstr1, apb_tim_clk),
    TIM3: (tim3, tim3en, tim3rst, apbenr1, apbrstr1, apb_tim_clk),
    TIM6: (tim6, tim6en, tim6rst, apbenr1, apbrstr1, apb_tim_clk),
    TIM7: (tim7, tim7en, tim7rst, apbenr1, apbrstr1, apb_tim_clk),
    TIM14: (tim14, tim14en, tim14rst, apbenr2, apbrstr2, apb_tim_clk),
    TIM15: (tim15, tim15en, tim15rst, apbenr2, apbrstr2, apb_tim_clk),
    TIM16: (tim16, tim16en, tim16rst, apbenr2, apbrstr2, apb_tim_clk),
    TIM17: (tim17, tim17en, tim17rst, apbenr2, apbrstr2, apb_tim_clk),
}
